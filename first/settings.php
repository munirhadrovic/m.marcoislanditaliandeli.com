<?php
	$adresa="247 N. Collier Blvd. Marco Island, FL 34145"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2393949493;// Broj koji se poziva na dugme CALL US
